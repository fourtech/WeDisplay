...
import com.ziluone.wedisplay.ForegroundService;
import com.ziluone.wedisplay.R;
import com.ziluone.wedisplay.WeDisplayService;
            ...
            mNaviBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    clickAction(new Runnable() {
                        ...
                        public void run() {
                            mPageType = BNDemoUtils.NORMAL;
                            final int did = WeDisplayService.getVirtualDisplayId();
                            Bundle bundle = null;
                            if (did >= 0) {
                                ActivityOptions options = ActivityOptions.makeBasic();
                                options.setLaunchDisplayId(did);
            ...
            public void onClick(View v) {
                clickAction(new Runnable() {
                    ...
                    public void run() {
                        ...
                        // startActivity(new Intent(DemoMainActivity.this, BNDemoLightNaviActivity.class).putExtras(bundle));

                        Intent navi = new Intent(DemoMainActivity.this, BNDemoLightNaviActivity.class);
                        navi.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(navi, bundle);
                        Log.i("@@@@@@@@", "lightNaviBtn 222");
                    }
                });
            }
        });
