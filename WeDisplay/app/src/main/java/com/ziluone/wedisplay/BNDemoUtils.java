...
import com.ziluone.wedisplay.activity.DemoAnalogActivity;
import com.ziluone.wedisplay.activity.DemoCruiserActivity;
import com.ziluone.wedisplay.activity.DemoDrawRectActivity;
import com.ziluone.wedisplay.activity.DemoDrivingActivity;
import com.ziluone.wedisplay.activity.DemoExtGpsActivity;
import com.ziluone.wedisplay.activity.DemoGuideActivity;
import com.ziluone.wedisplay.activity.DemoNaviSettingActivity;
import com.ziluone.wedisplay.activity.DemoSelectNodeActivity;
...
public class BNDemoUtils {
    ...
    public static final int LIGHT = 1 << 4;
     ...
     * 更多按钮 显示状态
     */
    public static final String KEY_GB_SHOW_MORE_BTN = "gb_showMoreBtn";
    ...
    public static void gotoNavi(Activity activity, Bundle bundle) {
        Intent it = new Intent(activity, DemoGuideActivity.class);
